...
//        femaleImage = findViewById(R.id.female_img);
        ...
        maleLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                maleLayout.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
        ...
        femaleLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                femaleLayout.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
...
//                maleImage.setColorFilter(getResources().getColor(R.color.grey));
    ...
    private void calculate(){
        ...
        ConditionCheck bmr = Factory.getConditionObject("BMR", w, h, a, user);

        result.setText(String.valueOf(bmr.getResult()));
