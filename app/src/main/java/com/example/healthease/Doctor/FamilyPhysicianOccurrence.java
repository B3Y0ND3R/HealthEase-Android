...
/**
 * Represents a family physician and their details.
 * Implements the AppointmentObserver interface to observe appointment changes.
 */
public class FamilyPhysicianOccurrence extends DoctorDetails implements AppointmentObserver {
    ...
    /**
     * Constructs a FamilyPhysicianOccurrence with the given details.
     *
     ...
     */
    public FamilyPhysicianOccurrence(String doctorName, String hospitalAddress, String experience, String mobileNo, int consultationFee) {
